...
resource "aws_eks_cluster" "my_cluster" {
  name     = "my-eks-cluster"
  role_arn = aws_iam_role.my_cluster_role_aws.arn
...
resource "aws_iam_role" "my_cluster_role_aws" {
...
resource "aws_eks_node_group" "my_node_group" {
  ...
  node_role_arn   = "arn:aws:iam::012912141676:role/aws-service-role/eks.amazonaws.com/AWSServiceRoleForAmazonEKS"
